...
<div class="container-fluid">
    ...
    <div class="row" style="height: 600px;">
        <div class="col-sm-12">
            ...
            <%--分页工具栏--%>
            <div class="row">
                <div class="col-sm-12 text-center"><%--控制分页是否居中--%>
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            ...
                            <c:if test="${requestScope.pageNow>1}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/student/findAll?pageNow=${requestScope.pageNow-1}&searchCol=${requestScope.searchCol}&searchValue=${requestScope.searchValue}" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a>
                                </li>
                            </c:if>
                            ...
                            <c:forEach begin="1" step="1" end="${requestScope.totalPage}" varStatus="state">
                                ...
                                <c:if test="${requestScope.pageNow!=state.count}">
                                    <li><a href="${pageContext.request.contextPath}/student/findAll?pageNow=${state.count}&searchCol=${requestScope.searchCol}&searchValue=${requestScope.searchValue}">${state.count}</a></li>
                                </c:if>
                            </c:forEach>
                            ...
                            <c:if test="${requestScope.pageNow<totalPage}">
                                <li >
                                    <a href="${pageContext.request.contextPath}/student/findAll?pageNow=${requestScope.pageNow+1}&searchCol=${requestScope.searchCol}&searchValue=${requestScope.searchValue}" aria-label="Next">
